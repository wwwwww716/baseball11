...
public class Count {
    ...
    private int correctCounter(List<Integer> user, List<Integer> computer, int correct) {
        for (int i = 0; i < 3; i++) {
    ...
    private int correctPlus(List<Integer> user, int correct, int number) {
    ...
    private int strikeCounter(List<Integer> user, List<Integer> computer, int strike) {
        for (int i = 0; i < 3; i++) {
    ...
    private int strikeCount(List<Integer> user, List<Integer> computer, int strike, int i) {
    ...
    private int strikePlus(int strike) {
        strike++;
        return strike;
    }
